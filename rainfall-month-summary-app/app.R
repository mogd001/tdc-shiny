...
map <- generate_rainfall_summary_plot(default_date, rainfall, r, max_rainfall, nelsontasman, context)
map_ly <- generate_rainfall_summary_plotly(default_date, rainfall, r, max_rainfall, nelsontasman, context)
